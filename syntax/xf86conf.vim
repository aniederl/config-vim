...
if b:xf86conf_xfree86_version >= 4
	syn region xf86confSection matchgroup=xf86confSectionDelim start="^\s*Section\s\+\"\(Files\|Server[_ ]*Flags\|Input[_ ]*Device\|Device\|Video[_ ]*Adaptor\|Server[_ ]*Layout\|DRI\|Extensions\|Vendor\|Keyboard\|Pointer\|Input[_ ]*Class\)\"" end="^\s*EndSection\>" skip="#.*$\|\"[^\"]*\"" contains=xf86confComment,xf86confOption,xf86confKeyword,xf86confSectionError
...
" input-synaptics
Xf86confdeclopt SHMConfig LeftEdge RightEdge TopEdge BottomEdge FingerLow FingerHigh FingerPress
Xf86confdeclopt MaxTapTime MaxTapMove MaxDoubleTapTime ClickTime FastTaps CornerCoasting
Xf86confdeclopt VertEdgeScroll  VertTwoFingerScroll  VertScrollDelta
Xf86confdeclopt HorizEdgeScroll HorizTwoFingerScroll HorizScrollDelta
Xf86confdeclopt EdgeMotionMinZ EdgeMotionMaxZ EdgeMotionMinSpeed EdgeMotionMaxSpeed EdgeMotionUseAlways
Xf86confdeclopt MinSpeed MaxSpeed AccelFactor TrackstickSpeed TouchpadOff
Xf86confdeclopt PressureMotionMinZ PressureMotionMaxZ PressureMotionMinFactor PressureMotionMaxFactor
Xf86confdeclopt UpDownScrolling UpDownScrollRepeat LeftRightScrolling LeftRightScrollRepeat
Xf86confdeclopt ScrollButtonRepeat EmulateMidButtonTime EmulateTwoFingerMinZ EmulateTwoFingerMinW
Xf86confdeclopt LockedDrags LockedDragTimeout RTCornerButton RBCornerButton LTCornerButton LBCornerButton
Xf86confdeclopt TapButton1 TapButton2 TapButton3 ClickFinger1 ClickFinger2 ClickFinger3
Xf86confdeclopt CircularScrolling CircScrollDelta CircScrollTrigger CircularPad
Xf86confdeclopt PalmDetect PalmMinWidth PalmMinZ CoastingSpeed CoastingFriction SingleTapTimeout
